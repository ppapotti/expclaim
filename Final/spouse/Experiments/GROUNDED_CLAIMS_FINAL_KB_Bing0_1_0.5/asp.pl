...
:~ unsat(70,"-0.7559480817989755", A, B, C, D).[-755@0,70, A, B, C, D]
 unsat(71,"6.668329895093629", A, B, C):- spouse( A, C), B!= C, type( B,"Thing"),not  negspouse( A, B).
 negspouse( A, B):- spouse( A, C), B!= C, type( B,"Thing"),not  unsat(71,"6.668329895093629", A, B, C).
...
:~ unsat(95,"2.0471532653022", A, B, C).[2047@0,95, A, B, C]
 birthPlace("George_Lucas","California").
 influencedBy("Leigh_Brackett","Edgar_Rice_Burroughs").
 deathPlace("Edgar_Rice_Burroughs","California").
 influenced("Leigh_Brackett","George_Lucas").
 occupation("Leigh_Brackett","Novelist").
 occupation("Leigh_Brackett","Screenwriter").
 deathPlace("Leigh_Brackett","Lancaster,_California").
 type("Leigh_Brackett","Person").
 type("Leigh_Brackett","Agent").
 type("Leigh_Brackett","Writer").
 type("Leigh_Brackett","Thing").
 type("George_Lucas","Person").
 type("George_Lucas","Agent").
 type("George_Lucas","Thing").
 spouse("Leigh_Brackett","Edmond_Hamilton").
