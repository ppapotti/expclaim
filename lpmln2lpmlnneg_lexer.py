import ply.lex as neg_lexer
import ply.yacc as yacc
from math import exp, expm1, log

class lpmln2lpmlnnet(object):
    ...
    def p_statement_14(self,t):
        ...
        weight = eval(self.g_parsedDic[id]['weight'])
        ...
        ipara = ""
        if var == "":
            para = "(" + "lpmlnneg_" + id + ",\"" + str(0 - weight) + "\"" + ")"
            para_2 = "(" + "lpmlnneg_" + id + ",\"" + weight_str + "\"" + ")"
            ipara = "[" + weight_int + " @ 0," + "lpmlnneg_" + id + "]"
        else:
            para = "(" + "lpmlnneg_" + id + ",\"" + str(0 - weight) + "\"" + "," + var + ")"
            para_2 = "(" + "lpmlnneg_" + id + ",\"" + weight_str + "\"" + "," + var + ")"
            ipara = "[" + weight_int + " @ 0," + "lpmlnneg_" + id + "," + var + "]"
        ...
        if weight >= 0:
            ...
            if len(t) == 5 and t[3] == ":-" and t[4] == '.':  # In the case of "num_process Head :- DOT"
                head = str(t[2])
                line_1 = "0 " + head + " :- " + "."
                line_2 = "neg" + para + " :- " + "not " + head
                line_3 = weight + " :- not neg" + para + "."
                line_2 += '.'
            ...
            if len(t) == 5 and t[3] == ":-" and t[4] == '.':  # In the case of "num_process Head :- DOT"
                head = str(t[2])
                line_1 = "unsat" + para_2 + " :- " + "not " + head + "."
                line_2 = head + " :- " + "not " + "unsat" + para_2 + "."
                line_3 = ":~" + "unsat" + para_2 + "." + ipara
                line = line_1 + "\n" + line_2 + "\n" + line_3
            elif len(t) == 5 and t[3] == ":-":  # In the case of  "num_process Head :- body DOT"
                head = str(t[2])
                body = str(t[4])
                line_1 = "unsat" + para_2 + " :- " + body[:len(body) - 1] + ",not " + head + "."
                line_2 = head + ":-" + body[:len(body) - 1] + ",not " + "unsat" + para_2 + "."
                line_3 = ":~" + "unsat" + para_2 + "." + ipara
                line = line_1 + "\n" + line_2 + "\n" + line_3
                ...
                body = str(t[3])
                line_1 = "unsat" + para_2 + " :- " + body
                line_2 = ":-" + body[:len(body) - 1] + " ,not " + "unsat" + para_2 + "."
                line_3 = ":~" + "unsat" + para_2 + "." + ipara
                line = line_1 + "\n" + line_2 + "\n" + line_3
    ...
    def build(self, **kwargs):
        self.lexer = neg_lexer.lex(module=self, **kwargs)

    def __init__(self,content,weightFactor):
        self.ruleCounter = 1
